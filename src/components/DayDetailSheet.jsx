...
import { formatDateKo, getDayLabel, today, formatDate } from '../utils/dateUtils';
...
export default function DayDetailSheet({ dateStr, selectedClass, onClose, onRentalChange }) {
  ...
  function handleDelete(id) {
    deleteRental(id); refresh(); onRentalChange();
  }
